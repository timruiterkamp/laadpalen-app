    ...
    <nav class="d-nav">
      <ul class="d-nav__list">
        <li class="d-nav__list-item">
          <nuxt-link @click.native="toggleNav" class="d-nav__link" to="/dashboard">Overzicht</nuxt-link>
        </li>
        <li class="d-nav__list-item">
          <nuxt-link
            @click.native="toggleNav"
            class="d-nav__link"
            to="/dashboard/meldingen"
          >Meldingen</nuxt-link>
        </li>
        <li class="d-nav__list-item">
          <nuxt-link
...
.d-header {
  ...
  @include shadow($size: 0.5rem, $alpha: 0.1);
  display: flex;
  flex-direction: row;
  z-index: 1;
